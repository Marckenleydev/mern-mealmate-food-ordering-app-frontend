...
const Footer = () => {
  return (
    <footer className="bg-orange-500 py-10 text-white ">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Contact Section */}
          <div className='text-white'>
            <h2 className="text-xl font-bold mb-4">Contact</h2>
            <p className="mb-2 text-white"><strong >Address:</strong> Thika town, Naltex building, 2nd floor</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link className=" ">Privacy Policy</Link></li>
              <li><Link className=" ">Terms & Conditions</Link></li>
              <li><Link className=" ">Fee Policy</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/cart" className=" ">View Cart</Link></li>
              <li><Link to="/contact" className=" ">Help</Link></li>
              <li><Link className=" ">Payments</Link></li>
              <li><Link className=" ">My Wishlist</Link></li>
              <li><Link className=" ">Coupons</Link></li>
            </ul>
          </div>
